...
% Kapitelbeschriftung bei Bildern entfernen
% \usepackage{chngcntr}
% \counterwithout{figure}{chapter}
% \counterwithout{table}{chapter}

% Abstände für "Caption" von Bilder und Tabellen (APA)
...
% \captionsetup[survey]{labelfont=bf,textfont=it,format=plain,justification=justified,singlelinecheck=false,labelsep=spaced,skip=0pt}
